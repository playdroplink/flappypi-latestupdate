# 📚 Complete Documentation Package – Flappy Pi
...
- **Flappy Coins** are strictly in-game currency.
- They **cannot be converted to Pi** or any other cryptocurrency or real-world value.
- Flappy Coins are used for in-game purchases, upgrades, and features only.
- **No external value:** Flappy Coins have no value outside the game and cannot be traded, sold, or exchanged for real money or Pi.
- **Future rewards:** Only Pi will be rewarded to users in the future for certain achievements or events. Flappy Coins will remain an in-game-only currency.
