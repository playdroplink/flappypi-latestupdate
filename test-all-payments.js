...
function main() {
  ...
  switch (command) {
    ...
    default:
      console.log('📖 Usage:');
      console.log('   node test-all-payments.js report       - Generate payment test report');
      console.log('   node test-all-payments.js instructions - Show testing instructions');
      console.log('   node test-all-payments.js code        - Generate test code');
      console.log('   node test-all-payments.js all         - Generate everything');
      console.log('');
      console.log('📋 Examples:');
      console.log('   node test-all-payments.js report       - See all payment items');
      console.log('   node test-all-payments.js instructions - How to test payments');
      console.log('   node test-all-payments.js code        - Browser test code');
  }
}
